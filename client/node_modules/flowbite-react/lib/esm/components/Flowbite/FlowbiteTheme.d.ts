...
import type { ButtonColors, ButtonGradientColors, ButtonGradientDuoToneColors, ButtonOutlineColors, ButtonSizes } from '../Button';
...
export declare type CustomFlowbiteTheme = DeepPartial<FlowbiteTheme>;
...
export declare type FlowbiteHeadingLevel = 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6';
