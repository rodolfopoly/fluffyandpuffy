...
const NavbarCollapse = ({ children, ...props }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)(theme.base, theme.hidden[!isOpen ? 'on' : 'off']), "data-testid": "navbar-collapse", ...theirProps, children: (0, jsx_runtime_1.jsx)("ul", { className: theme.list, children: children }) }));
};
