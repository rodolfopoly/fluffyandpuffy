...
const NavbarToggle = ({ barIcon: BarIcon = go_1.GoThreeBars, ...props }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("button", { className: theme.base, "data-testid": "navbar-toggle", onClick: handleClick, ...theirProps, children: [(0, jsx_runtime_1.jsx)("span", { className: "sr-only", children: "Open main menu" }), (0, jsx_runtime_1.jsx)(BarIcon, { className: theme.icon })] }));
};
